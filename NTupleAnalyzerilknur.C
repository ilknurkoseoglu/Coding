...
//----------------------Normalizing--------------------------------------------
    ...
    TTree *TreeB3= new TTree("TreeB3","Background Tree");
...
//    TreeS->Branch("LepPT",&LepPT_CUT);
    TreeS->Branch("METOHT",&METOHT_CUT);
...
//    TreeB->Branch("JET_Multp",&JET_Multp);
    ...
    TreeSR0->Branch("HT_SR0",&HT_CUT_SR0);
    TreeSR0->Branch("MET_SR0",&MET_CUT_SR0);
    TreeSR0->Branch("MT_SR0",&MT_CUT_SR0);
	//    TreeSR1->Branch("LepPT",&LepPT_CUT_SR1);
    TreeSR0->Branch("METOHT_SR0",&METOHT_CUT_SR0);
	//    TreeSR1->Branch("MT2W",&MT2W_CUT_SR1);
	//    TreeSR1->Branch("JET_Multp",&JET_Multp_SR1);


    TreeSR1->Branch("HT_SR1",&HT_CUT_SR1);
    TreeSR1->Branch("MET_SR1",&MET_CUT_SR1);
    TreeSR1->Branch("MT_SR1",&MT_CUT_SR1);
//    TreeSR1->Branch("LepPT",&LepPT_CUT_SR1);
    TreeSR1->Branch("METOHT_SR1",&METOHT_CUT_SR1);
//    TreeSR1->Branch("MT2W",&MT2W_CUT_SR1);
//    TreeSR1->Branch("JET_Multp",&JET_Multp_SR1);


    TreeSR2->Branch("HT_SR2",&HT_CUT_SR2);
    TreeSR2->Branch("MET_SR2",&MET_CUT_SR2);
    TreeSR2->Branch("MT_SR2",&MT_CUT_SR2);
//    TreeSR2->Branch("LepPT_SR2",&LepPT_CUT_SR2);
    TreeSR2->Branch("METOHT_SR2",&METOHT_CUT_SR2);
//    TreeSR2->Branch("MT2W",&MT2W_CUT_SR2);
//    TreeSR2->Branch("JET_Multp",&JET_Multp_SR2);

    TreeSR3->Branch("HT_SR3",&HT_CUT_SR3);
    TreeSR3->Branch("MET_SR3",&MET_CUT_SR3);
    TreeSR3->Branch("MT_SR3",&MT_CUT_SR3);
//    TreeSR3->Branch("LepPT_SR3",&LepPT_CUT_SR3);
    TreeSR3->Branch("METOHT_SR3",&METOHT_CUT_SR3);
//    TreeSR3->Branch("MT2W",&MT2W_CUT);
//    TreeSR3->Branch("JET_Multp",&JET_Multp);


    TreeSR4->Branch("HT_SR4",&HT_CUT_SR4);
    TreeSR4->Branch("MET_SR4",&MET_CUT_SR4);
    TreeSR4->Branch("MT_SR4",&MT_CUT_SR4);
//    TreeSR4->Branch("LepPT",&LepPT_CUT);
    TreeSR4->Branch("METOHT_SR4",&METOHT_CUT_SR4);
//    TreeSR4->Branch("MT2W",&MT2W_CUT);
//    TreeSR4->Branch("JET_Multp",&JET_Multp)


    TreeSR5->Branch("HT_SR5",&HT_CUT_SR5);
    TreeSR5->Branch("MET_SR5",&MET_CUT_SR5);
    TreeSR5->Branch("MT_SR5",&MT_CUT_SR5);
//    TreeSR5->Branch("LepPT",&LepPT_CUT_SR5);
    TreeSR5->Branch("METOHT_SR5",&METOHT_CUT_SR5);
//    TreeSR5->Branch("MT2W",&MT2W_CUT_SR1);
//    TreeSR5->Branch("JET_Multp",&JET_Multp_SR1);


    TreeSR6->Branch("HT_SR6",&HT_CUT_SR6);
    TreeSR6->Branch("MET_SR6",&MET_CUT_SR6);
    TreeSR6->Branch("MT_SR6",&MT_CUT_SR6);
//    TreeSR6->Branch("LepPT_SR6",&LepPT_CUT_SR6);
    TreeSR6->Branch("METOHT_SR6",&METOHT_CUT_SR6);
//    TreeSR6->Branch("MT2W",&MT2W_CUT_SR2);
//    TreeSR6->Branch("JET_Multp",&JET_Multp_SR2);

    TreeSR7->Branch("HT_SR7",&HT_CUT_SR7);
    TreeSR7->Branch("MET_SR7",&MET_CUT_SR7);
    TreeSR7->Branch("MT_SR7",&MT_CUT_SR7);
//    TreeSR7->Branch("LepPT_SR3",&LepPT_CUT_SR3);
    TreeSR7->Branch("METOHT_SR7",&METOHT_CUT_SR7);
//    TreeSR7->Branch("MT2W",&MT2W_CUT);
//    TreeSR7->Branch("JET_Multp",&JET_Multp);


    TreeSR8->Branch("HT_SR8",&HT_CUT_SR8);
    TreeSR8->Branch("MET_SR8",&MET_CUT_SR8);
    TreeSR8->Branch("MT_SR8",&MT_CUT_SR8);
//    TreeSR8->Branch("LepPT",&LepPT_CUT);
    TreeSR8->Branch("METOHT_SR8",&METOHT_CUT_SR8);
//    TreeSR8->Branch("MT2W",&MT2W_CUT);
//    TreeSR8->Branch("JET_Multp",&JET_Multp)


    TreeSR9->Branch("HT_SR9",&HT_CUT_SR9);
    TreeSR9->Branch("MET_SR9",&MET_CUT_SR9);
    TreeSR9->Branch("MT_SR9",&MT_CUT_SR9);
//    TreeSR7->Branch("LepPT_SR3",&LepPT_CUT_SR3);
    TreeSR9->Branch("METOHT_SR9",&METOHT_CUT_SR9);
//    TreeSR7->Branch("MT2W",&MT2W_CUT);
//    TreeSR7->Branch("JET_Multp",&JET_Multp);


    TreeSR10->Branch("HT_SR10",&HT_CUT_SR10);
    TreeSR10->Branch("MET_SR10",&MET_CUT_SR10);
    TreeSR10->Branch("MT_SR10",&MT_CUT_SR10);
//    TreeSR8->Branch("LepPT",&LepPT_CUT);
    TreeSR10->Branch("METOHT_SR10",&METOHT_CUT_SR10);
//    TreeSR8->Branch("MT2W",&MT2W_CUT);
//    TreeSR8->Branch("JET_Multp",&JET_Multp)
...
//---------------------------------------------------------------------------------------------------       
    ...
    TH1F* hLepMuonPt= new TH1F("hLepMuonPt","MuonPt after muon prese.",50,0,300);
    TH1F* hLepMuonEta=new TH1F("hLepMuonEta","MuonEta after muon prese.",100,-3,3);    
    TH1F* hLepElePt= new TH1F("hLepElePt","ElectronPt after elect. prese.",50,0,300);
        TH1F* hLepEleEta=new TH1F("hLepEleEta","ElectronEta after elect prese.",100,-3,3); 

    TH1F* hLepMuonPt2= new TH1F("hLepMuonPt2","MuonPt before muon prese.",50,0,300);
        TH1F* hLepMuonEta2=new TH1F("hLepMuonEta2","MuonEta before muon prese.",100,-3,3); 
        TH1F* hLepElePt2= new TH1F("hLepElePt2","ElectronPt before elect. prese.",50,0,300);
        TH1F* hLepEleEta2=new TH1F("hLepEleEta2","ElectronEta before elect prese.",100,-3,3); 


    //after MET_CUT
    TH1F*  hMET2= new TH1F("hMET2","after (D)MET<=250 cut",50,0,2500);
        TH1F*  apMET= new TH1F("apMET","after preselection MET",50,0,2500);
    TH1F*  apDMET= new TH1F("apDMET","after preselection MET",50,0,2500);
    TH1F*  bpMET= new TH1F("bpMET","before preselection MET",50,0,2500);
    TH1F*  bpDMET= new TH1F("bpDMET","before preselection MET",50,0,2500);

     //at 1lep 4jets 1b
        TH1F* aDphi      = new TH1F("aDphi","#Delta#phi",100,0,4);
        TH1F* aDelphDphi = new TH1F("aDelphDphi","Delphes #Delta#phi",100,0,4);

    TH1F* MuonPhiOS = new TH1F("MuonPhiOS","#Delta#phi OS Muon",100,-10,10);
	TH1F* MuonPhiSS = new TH1F("MuonPhiSS","#Delta#phi SS Muon",100,-10,10);
	TH1F* MuonPhiSSA = new TH1F("MuonPhiSSA","#Delta#phi SS Anti-Muon",100,-10,10);
	TH1F* ElectronPhiOS = new TH1F("ElectronPhiOS","#Delta#phi OS El",100,-10,10);
    TH1F* ElectronPhiSS = new TH1F("ElectronPhiSS","#Delta#phi SS El",100,-10,10);
    TH1F* ElectronPhiSSA = new TH1F("ElectronPhiSSA","#Delta#phi SS anti-El",100,-10,10);
    
    
    TH2F* hDelPhi_LpWpt = new TH2F("hDelPhi_LpWpt","DelPhi_LpWpt",10,-1.,1.,100,0.,2.);
    hDelPhi_LpWpt->GetYaxis()->SetTitle("P_{T}(lep)/P_{T}(W)");
    hDelPhi_LpWpt->GetXaxis()->SetTitle("cos(#Delta #phi (W,lep))");
    TH1F* hWpt = new TH1F("histWpt","Wpt",100,0,2500);
    hWpt->GetXaxis()->SetTitle("P_T (W) [GeV]");
    TH1F* hWpt2 = new TH1F("histWpt2","Wpt2",100,0,2500);
    TH1F* hCosDelPhiWlep = new TH1F("histCosDelPhiWlep","CosDelPhiWlep",100,-1., 1.);
    hCosDelPhiWlep->GetXaxis()->SetTitle("cos(#Delta #phi (W,lep))");
    TH1F* hRatio = new TH1F("hRatio","Ratio",100,0.,5.);
    hRatio->GetXaxis()->SetTitle("P_{T}(lep)/P_{T}(W)");
    TH1F* hLp = new TH1F("histLp","Lp",500,-5,5);
    hLp->GetXaxis()->SetTitle("Lp");
    
    
    
    TH2F* hDelPhi_LpWpt_ep = new TH2F("hDelPhi_LpWpt_ep","DelPhi_LpWpt secondlargest",10,-1.,1.,100,0.,2.);
    hDelPhi_LpWpt_ep->GetYaxis()->SetTitle("P_{T}(lep)/P_{T}(W)");
    hDelPhi_LpWpt_ep->GetXaxis()->SetTitle("cos(#Delta #phi (W,lep))");
    TH1F* hWpt_ep = new TH1F("histWpt_ep","Wpt secondlargest",100,0,2500);
    hWpt_ep->GetXaxis()->SetTitle("P_T (W) [GeV]");
    TH1F* hWpt2_ep = new TH1F("histWpt2_ep","Wpt2 secondlargest",100,0,2500);
    TH1F* hCosDelPhiWlep_ep = new TH1F("histCosDelPhiWlep_ep","CosDelPhiWlep secondlargest",100,-1., 1.);
    hCosDelPhiWlep_ep->GetXaxis()->SetTitle("cos(#Delta #phi (W,lep))");
    TH1F* hRatio_ep = new TH1F("hRatio_ep","Ratio secondlargest",100,0.,5.);
    hRatio_ep->GetXaxis()->SetTitle("P_{T}(lep)/P_{T}(W)");
    TH1F* hLp_ep = new TH1F("histLp_ep","Lp secondlargest",500,-5,5);
    hLp_ep->GetXaxis()->SetTitle("Lp");
    
    
    
    TH1F* ElectronCosPhiOS= new TH1F("ElectronCosPhiOS","cos(#Delta#phi) OS El",100,-1,1);
    TH1F* ElectronCosPhiSS= new TH1F("ElectronCosPhiSS","cos(#Delta#phi) SS El",100,-1,1);
    
    TH1F* MuonCosPhiOS= new TH1F("MuonCosPhiOS","cos(#Delta#phi) OS Mu",100,-1,1);
    TH1F* MuonCosPhiSS= new TH1F("MuonCosPhiSS","cos(#Delta#phi) SS Mu",100,-1,1);
    
    
    TH1F* CosPhiSFOS2= new TH1F("CosPhiSFOS2","cos(#Delta#phi) SameFlavour OS -El+El",100,-1,1);
    TH1F* CosPhiSFOS1= new TH1F("CosPhiSFOS1","cos(#Delta#phi) Same Flavour OS Mu-mu",100,-1,1);
    
    TH1F* CosPhiSFSS2= new TH1F("CosPhiSFOS2","cos(#Delta#phi) SameFlavour SS mu+ mu+",100,-1,1);
    TH1F* CosPhiSFSS1= new TH1F("CosPhiSFOS1","cos(#Delta#phi) Same Flavour SS e+e+",100,-1,1);
    TH1F* CosPhiSFSS3= new TH1F("CosPhiSFOS3","cos(#Delta#phi) Same Flavour SS e+mu+",100,-1,1);
    
        TH1F* PhiOFOS1= new TH1F("PhiOFOS1","#Delta#phi OS El-Mu=2 1el2mu",100,-10,10);
        TH1F* PhiOFOS2= new TH1F("PhiOFOS2","#Delta#phi OS El-Mu=24 1el2mu",100,-10,10);
    ...
    TH1F* PhiOFOS3= new TH1F("PhiOFOS3","#Delta#phi OS El-Mu=2 2el1mu",100,-10,10);
    TH1F* PhiOFOS4= new TH1F("PhiOFOS4","#Delta#phi OS El-Mu=24 2el1mu",100,-10,10);
    ...
    TH1F* CosPhiOFOS6= new TH1F("CosPhiOFOS6","cos(#Delta#phi) OFOS -Mu+El el,mu>1",100,-1,1);
    TH1F* CosPhiOFOS5= new TH1F("CosPhiOFOS5","cos(#Delta#phi) OFOS Mu-El el,mu>1",100,-1,1);
    
    TH1F* PhiOFOS5= new TH1F("PhiOFOS5","#Delta#phi OS El-Mu=2 el,mu>1",100,-10,10);
    TH1F* PhiOFOS6= new TH1F("PhiOFOS6","#Delta#phi OS El-Mu=24 el,mu>1",100,-10,10);
    
    TH1F* CosPhiOFOS7= new TH1F("CosPhiOFOS7","cos(#Delta#phi) OFOS -Mu+El el,mu>1",100,-1,1);
    TH1F* CosPhiOFOS8= new TH1F("CosPhiOFOS8","cos(#Delta#phi) OFOS Mu-El el,mu>1",100,-1,1);
    
    TH1F* PhiOFOS7= new TH1F("PhiOFOS7","#Delta#phi OS El-Mu=2 2el1mu",100,-10,10);
    TH1F* PhiOFOS8= new TH1F("PhiOFOS8","#Delta#phi OS El-Mu=24 2el1mu",100,-10,10);
    ...
    TH1F* MET_3   = new TH1F("E_{T}^{miss} [GeV] ","MET after all cuts",200,0,2000);
//    TH1F* MET_hist   = new TH1F("MET_hist","MET after all cuts",200,0,2000);
    ...
    TH1F* MT_1   = new TH1F("M_{T}_1 [GeV]","MT before cuts",100,0,2000);
        ...
        TH1F* MT_3   = new TH1F("M_{T} [GeV]","after all cuts",100,0,3000);
    ...
    TH1F* MT2W_1   = new TH1F("M_{T2}^{W}_1 [GeV]","before cuts",100,0,1000);
        ...
        TH1F* MT2W_3   = new TH1F("M_{T2}^{W} [GeV]","after all cuts",100,200,600);
    ...
    TH1F* HT_3    = new TH1F("HT [GeV]","after all Cuts",100,0,7000);
    ...
    TH1F* hDelphdphi  = new TH1F("hDelphdphi","#Delta#phi",100,0,4);
        TH1F* hDelphdphi_2  = new TH1F("hDelphdphi_2","#Delta#phi>=0.8",100,0,4);    
...
//        cout<<"size of muon for disinda Nmu_loose"<<Nmu_loose<<endl;
//        cout<<"size of electron for disinda Nel_loose"<<Nel_loose<<endl;
        // 
...
//        double LepPt=0;
    ...
    //    cout<<"Bitti"<<endl;
        ...
        double max=0;
         double max2,largest,dblarge,dblargehold=0;
  ...
  //      cout<<"deltaR"<<deltaR<<endl;
   //     cout<<"2ndlargest"<<secondlargest<<endl;
    //    cout<<"phi2"<<phi2<<endl;
     ...
     /*   for(int bb=0;bb<(Nel_tight+Nmu_tight);++bb){
                cout<<"LTLepton[bb].Pt();DONGUDEN ONCE"<<LTLepton[bb].Pt()<<endl;
                if(deltaR<0.3){
                     PT_R+=LTLepton[bb].Pt();
                    cout<<"LTLepton[bb].Pt();"<<LTLepton[bb].Pt()<<endl;
            }
        }*/
        double PT_Ele=0;
     /*   for(int dd=0;dd<(Nel_tight+Nmu_tight);++dd){
           // cout<<Ch_Lepton[dd]<<endl;
            if(Ch_Lepton[dd]%11==0){
                PT_Ele=LTLepton[dd].Pt();
                IsoElectron->Fill(PT_R/PT_Ele);
            }
        }*/
        //IsoElectron->Fill(PT_R/PT_Ele);
//        cout<<"deltaR"<<deltaR<<endl;
       // cout<<"tmu_size"<<tmu_size<<endl;

        
   //     cout<<"Nel_loose+Nmu_loose=  "<<Nel_loose+Nmu_loose<<endl;
//        LepPt=ElPt+MuPt;
...
*/
    ...
    hLepMuonEta2->Write();
    hLepEleEta2->Write();
    ElectronCosPhiOS->Write();
    ElectronCosPhiSS->Write();
